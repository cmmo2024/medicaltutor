    ...
    if (error) {
        if (previousPlanId) {
            ...
            if (planButton) {
                ...
                const receiverId = planButton.getAttribute('data-receiver-id');
                const phoneNumber = planButton.getAttribute('data-phone');
                const qrCodeUrl = planButton.getAttribute('data-qr-code');
